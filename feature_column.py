...
class SparseFeat(namedtuple('SparseFeat',
    ...
    Args:
        name: feature name,
        vocabulary_size: max value index of the feature.
        embedding_dim: embedding dim of the feature
        use_hash: whether or not use hash when embedding
        vocabulary_path:
        dtype: data type of the feature.
        embeddings_initializer: initialize the embedding
        embedding_name: embedding name
        group_name: group name of embedding
...
class VarLenSparseFeat(namedtuple('VarLenSparseFeat',
    ...
    """ VarLenSparse feature
    Args:
        sparsefeat: Sparse feature type
        maxlen: max len of the sequence feature,
        combiner: max value index of the feature.
...
def build_input_features(feature_columns, prefix=''):
    """
    build input layer of the model
    ...
    Returns:
        input_features: input layer of the model
...
def get_linear_logit(features, feature_columns, units=1, use_bias=False, seed=1024, prefix='linear',
    ...
    Args:
        ...
        prefix: prefix
        l2_reg:l2_reg
        sparse_feat_refine_weight: sparse_feat_refine_weight

    Returns:
        output: output layer of linear part
...
def input_from_feature_columns(features, feature_columns, l2_reg, seed, prefix='', seq_mask_zero=True,
    ...
    """
    get embedding layer of the model
    Args:
        features: input layer
        feature_columns: feature list, define type of feature
        l2_reg: l2_reg
        prefix: prefix
        seq_mask_zero: whether sequence feature mask zero
        support_dense: whether support dense
        support_group:whether support group

    Returns:
        output: output of embedding layer

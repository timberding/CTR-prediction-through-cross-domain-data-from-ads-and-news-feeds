...
Reference:
    [1] Wang R, Fu B, Fu G, et al. Deep & cross network for ad click predictions[C]//Proceedings of the ADKDD'17. ACM, 2017: 12.
    (https://arxiv.org/abs/1708.05123)

    [2] Wang R, Shivanna R, Cheng D Z, et al. DCN-M: Improved Deep & Cross Network for Feature Cross Learning in
    Web-scale Learning to Rank Systems[J]. 2020. (https://arxiv.org/abs/2008.13535)
"""
...
class DCN(namedtuple('DCN', ['linear_feature_columns', 'dnn_feature_columns', 'cross_num', 'cross_parameterization',
                             'dnn_hidden_units', 'l2_reg_linear', 'l2_reg_embedding', 'l2_reg_cross', 'l2_reg_dnn',
                             'seed', 'dnn_dropout', 'dnn_use_bn', 'dnn_activation', 'task'])):

    def __new__(cls, linear_feature_columns, dnn_feature_columns, cross_num=2, cross_parameterization='vector',
